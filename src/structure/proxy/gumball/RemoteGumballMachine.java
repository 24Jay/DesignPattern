...
import structure.proxy.gumball.state.HasQuarter;
import structure.proxy.gumball.state.NoQuarter;
import structure.proxy.gumball.state.Sold;
import structure.proxy.gumball.state.Soldout;
